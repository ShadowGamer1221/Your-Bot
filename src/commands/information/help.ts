...
class HelpCommand extends Command {
    ...
    async run(ctx: CommandContext) {
        ...
        if(ctx.args['command-name']) {
            ...
            let msgData = { embeds: [ embeds[index].embed.setDescription(embeds[index].embed.description += `\n**Previous Page: ${previousModule} | Next Page: ${nextModule}**`) ], components: []};
            this.addButton(msgData, "previousButton", "Previous Page", "PRIMARY");
            this.addButton(msgData, "nextButton", "Next Page", "PRIMARY");
